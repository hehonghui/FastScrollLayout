 ...
 *
 * see : https://github.com/nolanlawson/SuperSaiyanScrollView
 * @author nolan
 * 
 */
public class SuperSaiyanScrollView extends RelativeLayout
    ...
    private static final int THUMB_DRAWABLE_PRESSED = R.drawable.scroll;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mOverlayDrawable = getContext().getResources().getDrawable(mOverlayDrawableResId);
    ...
    private void drawAlphabetOverlay(Canvas canvas) {
